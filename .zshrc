...
alias bare='/usr/bin/git --git-dir=$HOME/.mybaregit/ --work-tree=$HOME'
alias bareui='GIT_DIR=$HOME/.mybaregit GIT_WORK_TREE=$HOME gitk --all $( git fsck --no-reflog | awk '"'"'/dangling commit/ {print $3}'"'"' )'
...
cc() {
    ...
    case "$remainder" in
        ...
        1) settings="$HOME/.claude/env.trial.json" ;;
        2) settings="$HOME/.claude/env.trial2.json" ;;
        3) settings="$HOME/.claude/env.trial3.json" ;;
    esac
...
export PATH="/Users/danhtran/.bun/bin:$PATH"
